        ...
        @else
            ...
            <div class="container-fluid py-2">
                <div id="carouselDcp" class="carousel slide" data-bs-ride="carousel" data-bs-interval="8000">
                    ...
                    @if ($chunks->count() > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselDcp"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon"></span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselDcp"
                            data-bs-slide="next">
...
@push('scripts')
    ...
    <style>
        ...
        .line-clamp-title {
            ...
            min-height: 2.6em;
            /* Jaga tinggi tetap stabil meskipun judul 1 baris */
        }
